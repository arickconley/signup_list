...
@php
    $variants = [
        ...
        'ledger' => 'border-teal-900 bg-teal-800 text-white hover:bg-teal-950 dark:border-teal-300 dark:bg-teal-400 dark:text-stone-950 dark:hover:bg-teal-300',
...
<button
    ...
    {{ $attributes->class([
        ...
        'rounded-none' => $variant === 'ledger',
        'rounded-lg' => $variant !== 'ledger',
